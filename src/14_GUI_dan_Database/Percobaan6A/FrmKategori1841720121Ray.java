...
public class FrmKategori1841720121Ray extends javax.swing.JFrame {
    ...
    public void tampilkanData(){
        ...
        ArrayList<Kategori1841720121Ray> list = new Kategori1841720121Ray().getAllRay();
        Object rowData[] = new Object[3];
        
        tblKategori.setModel(new DefaultTableModel(new Object[][] {}, kolom));
        
        for(Kategori1841720121Ray kat : list){
            rowData[0] = kat.getIdkategoriRay();
            rowData[1] = kat.getNamaRay();
            rowData[2] = kat.getKeteranganRay();
    ...
    public void cari(String keyword){
        String[] kolom = {"ID", "Nama", "Keterangan"};
        ArrayList<Kategori1841720121Ray> list = new Kategori1841720121Ray().searchRay(keyword);
        Object rowData[] = new Object[3];
     ...
     */
    public FrmKategori1841720121Ray() {
        initComponents();
        tampilkanData();
        kosongkanForm();
    }
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        kat.setIdkategoriRay(Integer.parseInt(txtIdKategori.getText()));
        kat.setNamaRay(txtNama.getText());
        kat.setKeteranganRay(txtKeterangan.getText());
        kat.saveRay();
        txtIdKategori.setText(Integer.toString(kat.getIdkategoriRay()));
        tampilkanData();
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Kategori1841720121Ray kat = new Kategori1841720121Ray().getByIdRay(Integer.parseInt(model.getValueAt(row, 0).toString()));
        kat.deleteRay();
        kosongkanForm();
        tampilkanData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmKategori1841720121Ray.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmKategori1841720121Ray().setVisible(true);
            }
        });
    }
