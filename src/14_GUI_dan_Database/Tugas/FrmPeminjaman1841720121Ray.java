...
public class FrmPeminjaman1841720121Ray extends javax.swing.JFrame {

    /**
     * Creates new form FrmPeminjaman
     */
    public FrmPeminjaman1841720121Ray() {
        initComponents();
        tampilkanData();
        kosongkanForm();
    }
    ...
    public void tampilkanData(){
        ...
        ArrayList<Peminjaman1841720121Ray> list = new Peminjaman1841720121Ray().getAllRay();
        Object rowData[] = new Object[5];
        
        tblPeminjaman.setModel(new DefaultTableModel(new Object[][] {}, kolom));
        
        for (int i = 0; i < list.size(); i++) {
            rowData[0] = list.get(i).getIdpeminjamanRay();
            rowData[1] = list.get(i).getAnggotaRay().getNamaRay();
            rowData[2] = list.get(i).getBukuRay().getJudulRay();
            rowData[3] = list.get(i).getTanggalpinjamRay();
            rowData[4] = list.get(i).getTanggalkembaliRay();
    ...
    public void cariAnggota(String keyword){
        Anggota1841720121Ray anggota = new Anggota1841720121Ray().getByIdRay(Integer.parseInt(keyword));
        jLabel6.setText("Nama Anggota : "+anggota.getNamaRay());
    }
    
    public void cariBuku(String keyword){
        Buku1841720121Ray buku = new Buku1841720121Ray().getByIdRay(Integer.parseInt(keyword));
        jLabel7.setText("Judul Buku : "+buku.getJudulRay());
    }
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        Peminjaman1841720121Ray pmj = new Peminjaman1841720121Ray();
        pmj.setIdpeminjamanRay(Integer.parseInt(txtIdPeminjaman.getText()));
        
        Anggota1841720121Ray anggota = new Anggota1841720121Ray().getByIdRay(Integer.parseInt(txtIdAnggota.getText()));
        Buku1841720121Ray buku = new Buku1841720121Ray().getByIdRay(Integer.parseInt(txtIdBuku.getText()));
        
        pmj.setAnggotaRay(anggota);
        pmj.setBukuRay(buku);
        pmj.setTanggalpinjamRay(txtTanggalPinjam.getText());
        pmj.setTanggalkembaliRay(txtTanggalKembali.getText());
        pmj.saveRay();
        txtIdPeminjaman.setText(Integer.toString(pmj.getIdpeminjamanRay()));
        tampilkanData();
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Peminjaman1841720121Ray pmj = new Peminjaman1841720121Ray().getByIdRay(Integer.parseInt(model.getValueAt(row, 0).toString()));
        pmj.deleteRay();
        kosongkanForm();
        tampilkanData();
    ...
    private void tblPeminjamanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblPeminjamanMouseClicked
        ...
        int row = tblPeminjaman.getSelectedRow();
        Peminjaman1841720121Ray pmj = new Peminjaman1841720121Ray();
        pmj = pmj.getByIdRay(Integer.parseInt(model.getValueAt(row, 0).toString()));
        
        txtIdPeminjaman.setText(String.valueOf(pmj.getIdpeminjamanRay()));
        txtIdAnggota.setText(String.valueOf(pmj.getAnggotaRay().getIdAnggotaRay()));
        jLabel6.setText("Nama Anggota : "+pmj.getAnggotaRay().getNamaRay());
        
        txtIdBuku.setText(String.valueOf(pmj.getBukuRay().getIdbukuRay()));
        jLabel7.setText("Judul Buku : "+pmj.getBukuRay().getJudulRay());
        
        txtTanggalPinjam.setText(pmj.getTanggalpinjamRay());
        txtTanggalKembali.setText(pmj.getTanggalkembaliRay());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmPeminjaman1841720121Ray.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmPeminjaman1841720121Ray().setVisible(true);
            }
        });
    }
