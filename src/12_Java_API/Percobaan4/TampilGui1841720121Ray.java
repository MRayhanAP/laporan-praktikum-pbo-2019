...
public class TampilGui1841720121Ray extends javax.swing.JFrame {
    ...
    InputData1841720121Ray DataMahasiswa;
    
    public TampilGui1841720121Ray() {
        initComponents();
        DataMahasiswa = new InputData1841720121Ray();
        LihatDataMahasiswa();
    }
    
    public final void LihatDataMahasiswa(){
        String[] NamaKolom={"NIM", "Nama Mahasiswa", "Alamat"};
        Object[][] objekMahasiswa = new Object [DataMahasiswa.getDataRay().size()][3];
        int i = 0;
        for (Mahasiswa1841720121Ray mhs: DataMahasiswa.getDataRay
        ()){
            String arrayMahasiswa[] = {mhs.getNimRay(), mhs.getNamaRay(), mhs.getAlamatRay()};
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(jTextAlamat, javax.swing.GroupLayout.DEFAULT_SIZE, 300, Short.MAX_VALUE)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        DataMahasiswa.isiDataRay(jTextFieldNim.getText(), jTextFieldNama.getText(), jTextAlamat.getText());
        LihatDataMahasiswa();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TampilGui1841720121Ray.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TampilGui1841720121Ray().setVisible(true);
            }
        });
    }
