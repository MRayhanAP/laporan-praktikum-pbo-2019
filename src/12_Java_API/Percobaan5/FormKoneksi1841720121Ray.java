 ...
 * @author ASUS
 */
public class FormKoneksi1841720121Ray extends javax.swing.JFrame {
...
private static void buka_koneksi(){
     ...
     */
    public FormKoneksi1841720121Ray() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormKoneksi1841720121Ray.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormKoneksi1841720121Ray().setVisible(true);
            }
        });
    }
