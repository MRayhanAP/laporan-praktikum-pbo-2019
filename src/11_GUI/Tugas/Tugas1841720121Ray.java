 ...
 * @author ASUS
 */
public class Tugas1841720121Ray extends javax.swing.JFrame {
    private float x;
    private String op;
    /**
     * Creates new form Tugas
     */
    public Tugas1841720121Ray() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tugas1841720121Ray.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Tugas1841720121Ray().setVisible(true);
            }
        });
    }
